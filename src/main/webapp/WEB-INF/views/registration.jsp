...
<head>
    ...
    <!-- CSS here -->
        ...
        <link rel="stylesheet" href="${path}/resources/assets/css/owl.carousel.min.css">
        ...
        <link rel="stylesheet" href="${path}/resources/assets/css/animate.min.css">
        <link rel="stylesheet" href="${path}/resources/assets/css/magnific-popup.css">
        <link rel="stylesheet" href="${path}/resources/assets/css/fontawesome-all.min.css">
        <link rel="stylesheet" href="${path}/resources/assets/css/themify-icons.css">
        <link rel="stylesheet" href="${path}/resources/assets/css/slick.css">
        <link rel="stylesheet" href="${path}/resources/assets/css/nice-select.css">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                ...
                                <form class="row contact_form" action="${url }/memberJoinProc" method="post" novalidate="novalidate">
                                    <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" id="memberId" name="memberId" value="" placeholder="memberID">
                                    </div>
                                    <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" id="userName" name="userName" value="" placeholder="userName">
                                    </div>
                                    <div class="col-md-12 form-group p_star">
                                        <input type="password" class="form-control" id="pw" name="pw" value="" placeholder="pw">
                                    </div>
                                    <div class="col-md-12 form-group p_star">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <a class="registraion_cancle" href="#">√Îº“</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_text text-center">
                            <div class="login_part_text_iner">
                                <h2>Welcome !</h2>
                                <a href="login.html" class="btn_3">Go Login</a>
                            </div>
                        </div>
                    </div>
                </div>
